...
class PosController extends BaseController
{
    ...
    public function customerLoyalty(Request $r,int $id): void { Response::success('Customer loyalty snapshot.',$this->pos->customerLoyalty($id)); }
    ...
    public function auditLogs(Request $r): void { Response::success('POS audit logs retrieved.',$this->pos->auditLogs($r->getQueryParams())); }
}
